    ...
    return (
        <Box>
            ...
            >
                ...
                <GridItem w='100%' h='300px' border='1px solid #f5f5f5' boxShadow={'2xl'}
                    _hover={{ textDecoration: 'underline', color: 'blue.400' }}
                    cursor='pointer'

                >
                    <Flex h='300px' alignItems='center' >
                        <Image mh='100%' mw='100%' src='https://m.media-amazon.com/images/I/61+on0q5FHL._AC_SX255_.jpg' />
                    </Flex>
                    <Center><Text mt='10px' as='button'
                ...
                >
                    <Flex h='300px' alignItems='center' >
                        <Image h='100%' mw='100%' src='https://m.media-amazon.com/images/I/71XNQyih6WL._AC_SX255_.jpg' />
                    </Flex>
                    <Center><Text mt='10px' as='button'
